...
public class ItemTemplate {
    ...
    public static JSONObject ObjectItem(Item item, int index) {
        ...
        for (ItemOption Option : item.itemOptions) {
            ...
            if(Option.id == 93 && (item.timeHSD - System.currentTimeMillis() > 0)) {
    ...
    public static Item parseItem(String str) {
        ...
        for (Object Option2 : Option) {
            ...
            if(Integer.parseInt(job2.get((Object)"id").toString()) < 0 || Integer.parseInt(job2.get((Object)"id").toString()) > 223) {
                return null;
            }
