...
//        this.itemOptions = _item.itemOptions;
    ...
    public String getInfoUpStar(Player _player) {
        ...
        if(_player.vang >= (getGoldUpStar(starItem)*1L)) {
    ...
    public boolean isPet2() {
        return this.template.id == 892 || this.template.id == 893 || this.template.id == 908 || this.template.id == 909 || this.template.id == 910 ||
                this.template.id == 916 || this.template.id == 917 || this.template.id == 918 || this.template.id == 919 || this.template.id == 936 ||
                this.template.id == 942 || this.template.id == 943 || this.template.id == 944 || this.template.id == 967 || this.template.id == 1008 ||
                this.template.id == 1039 || this.template.id == 1040 || this.template.id == 1046 || this.template.id == 1107 || this.template.id == 1114;
    }
    public boolean isPet3() {
        return this.template.id == 1046 || this.template.id == 1107 || this.template.id == 1114 || this.template.id == 1147;
               
    }
    
    public boolean ItemEvent(){
        return this.template.id == 1165|| this.template.id ==1166 || this.template.id == 1168;
