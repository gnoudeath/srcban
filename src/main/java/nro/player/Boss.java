...
//    public Detu(Player n) {
    public Boss(int Id, byte type, short xBoss, short yBoss) {
        ...
        // -200140 Poc, -200141 Pic, -200142 KingKong, -200143 Xen 1, -200144 Xen 2, -200145 Xen hoan thien, -200531 SuperBee, -200529 Bill, -200530 Wish, -200532 ColerGold, -200534 FideGold, -200535 CumBer,
...
//            this.NhapThe =0;
            ...
            this.typePk = 5;
            this.isBOSS = true;
        } else if(type == (byte)51) { //SUPER BEE
            this.name = "Super Bee";
            this.head = 1083;
            this.hpGoc = 1500000000;
            this.mpGoc = 500;
