...
public class Util {
    ...
    public static String strPercentPower(long power) {
        ...
        if(power >= 100010000000L) {
            powerNext = 121000000000L;
            powerPrev = 110010000000L;
        } else if(power >= 100010000000L) {
            powerNext = 110010000000L;
            powerPrev = 100010000000L;
        } else if(power >= 90010000000L) {
            powerNext = 100010000000L;
            powerPrev = 90010000000L;
        } else if(power >= 80010000000L) {
            powerNext = 90010000000L;
            powerPrev = 80010000000L;
        } else if(power >= 70010000000L) {
            powerNext = 80010000000L;
