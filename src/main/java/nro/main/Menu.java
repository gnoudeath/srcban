        ...
        switch (p.menuNPCID) {
                    ...
                    if (p.menuID == -1) {
                        if (select == 0) {
                            doMenuArray(p, idNpc, "LIST BOSS", new String[]{"Broly", "Super Broly", "Cooler", "Cooler 2", "Black",
                                ...
                                "Xên Con", "Siêu Bọ\nHung", "Trung úy\nTrắng", "Trung úy\nXanh Lơ", "Trung úy\nThép", "Ninja\nÁo Tím", "Robốt\nVệ Sĩ",
                                "Drabura", "Pui Pui", "Ya Côn", "Ma Bư", "Chilled", "Chilled 2", "Dr Lychee", "Hatchiyack", "Tập sự", "Tân binh", "Chiến binh", "Đội trưởng", "Zamasu", "Bill", "Whis", "Super Bee"});
                        } else if (select == 1) {
                            m = null;
                            try {
                                m = new Message(-125);
            ...
            case 56: { //WHIS TODO
                if (p.map.id == 154) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            if (p.checkFullHuyDiet()) { //OPEN CUA HANG THIEN Su
                    ...
                    if (p.menuID == -1) {
                        if (select == 0) {
                            if (Server.gI().openHiru) {
                                ...
                                if (keyHiru != -1 && p.ItemBag[keyHiru].quantity >= 1) {
                                    p.ItemBag[keyHiru].quantity -= 1;
                                    ...
                                    p.sendAddchatYellow("Cần 1 Capsule hồng để tiến vào đây");
                                }
                            } else {
            ...
            case 44: { //OSIN
                if (p.map.id == 50) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            ...
                            if (p.power >= 100000000000L) {
                                ...
                                p.sendAddchatYellow("Ngươi cần đạt 100 tỷ sức mạnh mới có thể tới đây");
                            }
                        } else {
                            break;
                        }
                    ...
                    if (p.menuID == -1) {
                        if (select == 0) {
                            TabItemShop[] test = Shop.getTabShop(44, 0).toArray(new TabItemShop[0]);
                            GameScr.UIshop(p, test);
                        } else if (select == 1) {
                            if (p.power >= 100000000000L) {
            ...
            case 13: {
                if (p.map.id == 5) {
                    if (p.menuID != -1) {
                        ...
                        if (p.menuID == 2 && select == 0) { //titan
                            ...
                            if (Server.gI().isServer == (byte) 1) {
                                ...
                                p.sendAddchatYellow("Có cái đầu cặc");
                            }
                            break;
                            ...
                            if (select == 0 && p.balance >= 10000) {
                                if (HelperDAO.payMoneyDB(p, 10000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        ...
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 20 thỏi vàng");
                                    } else {
                                ...
                                if (HelperDAO.payMoneyDB(p, 20000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        Item thoivang = new Item(thoivangTemp);
                                        thoivang.quantity = 44;
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 44 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                } else {
                                ...
                                if (HelperDAO.payMoneyDB(p, 30000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        Item thoivang = new Item(thoivangTemp);
                                        thoivang.quantity = 72;
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 72 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                ...
                                if (HelperDAO.payMoneyDB(p, 50000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        Item thoivang = new Item(thoivangTemp);
                                        thoivang.quantity = 140;
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 140 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                ...
                                if (HelperDAO.payMoneyDB(p, 100000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        ...
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 300 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                } else {
                                ...
                                if (HelperDAO.payMoneyDB(p, 200000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        Item thoivang = new Item(thoivangTemp);
                                        thoivang.quantity = 640;
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 640 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                ...
                                if (HelperDAO.payMoneyDB(p, 500000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        ...
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 2000 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                                } else {
                                ...
                                if (HelperDAO.payMoneyDB(p, 1000000, false)) {
                                    ...
                                    if (thoivangTemp != null) {
                                        Item thoivang = new Item(thoivangTemp);
                                        thoivang.quantity = 4400;
                                        p.addItemToBag(thoivang);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được 4400 thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Đổi vàng thất bại");
                                    }
                    ...
                    if (select == 2) {
                        doMenuArray(p, idNpc, "Ta có thể giúp gì cho con", new String[]{"BXH Sức mạnh", "BXH Nạp thẻ", "BXH Sự kiện", "BXH Sự Kiện\b Đổi Quà"});
                        p.menuID = select;
                    } else if (select == 3) {
                        doMenuArray(p, idNpc, "Ta có thể giúp gì cho con", new String[]{"Giải tán\nbang hội", "Khu vực\nbang hội"});
                        p.menuID = select;
                    } else if (select == 4) {
                        doMenuArray(p, idNpc, "Bạn đang có " + p.balance + " , bạn muốn làm gì ?", new String[]{"20 Thỏi Vàng\n(10.000)",
                            "40 Thỏi Vàng\n(20.000)", "72 Thỏi Vàng\n(30.000)", "140 Thỏi Vàng\n(50.000)", "300 Thỏi Vàng\n(100.000)",
                            "640 Thỏi Vàng\n(200.000)",
                            "2000 Thỏi Vàng\n(500.000)", "4400 Thỏi Vàng\n(1.000.000)",});
                        p.menuID = select;;
                    }
                }
                break;
...
//         System.out.println("select: "+ select);
    ...
    public void openUINpc(Player p, Message m) throws IOException {
        ...
        if (p.menuNPCID == 74 && p.map.id == 5) {
            doMenuArray(p, idnpc, "Ò Ò sự Kiện Đua chơi chơi á mà\blụm x99 cần sa rồi đưa đây cho anh anh cho quà\bHoặc đem đủ 99kg thịt lợn qua đây\bĐổi quà Bình dân và Quà Sử thi để lấy hòm ulatr nhé ", new String[]{"Quà Bình Dân", "Quả Sử Thi", "Quà U là TR", "Bxh Sự Kiện", "đóng"});
            return;
            ...
            doMenuArray(p, idnpc, "Hãy cố gắng tập luyện\nThu thập 9.99 bí kiếp để đổi trang phục Yardrat nhé", new String[]{"Nhận thưởng", "OK"});
            return;
            ...
            if (p.map.id == 0) {
                doMenuArray(p, idnpc, "Ta bán đồ Tết ngươi có muốn xem thử?", new String[]{"Shop tết"});
            }
            return;
...
//                doMenuArray(p,idnpc,Text.get(0, 1),new String[]{"Cửa Hàng"});
            ...
            if ((p.menuNPCID == 0 && p.map.id == 21) || (p.menuNPCID == 1 && p.map.id == 23) || (p.menuNPCID == 2 && p.map.id == 22)) {
                ...
                if (p.hasTrungMabu) {
                    doMenuArray(p, idnpc, Text.get(0, 0), new String[]{"GiftCode", "Nhận Ngọc", "Quà Tân Thủ", "Đệ Tử\nMabư"});
                } else {
                    doMenuArray(p, idnpc, Text.get(0, 0), new String[]{"GiftCode", "Nhận Ngọc", "Quà Tân Thủ"});
                }
            }
            return;
            ...
            if (p.gender == 2) {
                ...
                doMenuArray(p, idnpc, Text.get(0, 1), new String[]{"Cửa Hàng", "next nv 7s"});
            } else {
            ...
            if (p.imgNRSD == (byte) 53) {
                ...
                if (p.gender == 1) {
                    ...
                    doMenuArray(p, idnpc, Text.get(0, 1), new String[]{"Cửa Hàng", "nv7s"});
...
//            doMenuArray(p,idnpc,"Ta có thể giúp gì cho con",new String[]{"Nói chuyện","Tính năng","Đá nâng cấp","Bang hội"});
            doMenuArray(p, idnpc, "Ta có thể giúp gì cho con", new String[]{"Nói chuyện", "Tính năng", "BXH", "Bang hội", "Quỹ nạp", "Nhận Quà Sự Kiện"});
            return;
