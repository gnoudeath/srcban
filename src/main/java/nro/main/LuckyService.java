...
public class LuckyService {
    ...
    public void resultLucky(Player p, byte type, byte count) {
        if(type == (byte)2) {
            int idItemNotSell[] = {17,18,19,20, 441,442,443,444,445,446,447, 190, 225, 220,221,222,223,224,999,998,
...
//                    id = Util.nextInt(0, 32);
                    id = Util.nextInt(0, idItemNotSell.length);
//                    id = Util.nextInt(0, 74);
    ...
    public boolean itemHasTime(int id) {
        int hasTime[] = {746,936,740,733,635,636,637,865,919,1000,999,998};
